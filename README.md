...
아래 시스템 구성도를 통해 '내담' 챗봇이 어떻게 작동하는지 한눈에 파악할 수 있습니다. 사용자의 질의가 입력되면, LangGraph를 통해 정의된 워크플로우에 따라 관련 문서가 검색되고, Ollama LLM을 통해 답변이 생성되는 일련의 과정을 보여줍니다.


&nbsp; <img src="overview.png" width="400" height="240" alt="시스템 구성도">
